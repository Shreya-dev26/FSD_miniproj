...
const DATGUI = dynamic(() => import('dat.gui'), { ssr: false }); // Use dynamic import for dat.gui
...
import bgTexture1 from '@/assets/images/1.jpg';
import bgTexture2 from '@/assets/images/2.jpg';
import bgTexture3 from '@/assets/images/3.jpg';
import bgTexture4 from '@/assets/images/4.jpg';
import sunTexture from '@/assets/images/sun.jpg';
import mercuryTexture from '@/assets/images/mercurymap.jpg';
import mercuryBump from '@/assets/images/mercurybump.jpg';
import venusTexture from '@/assets/images/venusmap.jpg';
import venusBump from '@/assets/images/venusmap.jpg';
import venusAtmosphere from '@/assets/images/venus_atmosphere.jpg';
import earthTexture from '@/assets/images/earth_daymap.jpg';
import earthNightTexture from '@/assets/images/earth_nightmap.jpg';
import earthAtmosphere from '@/assets/images/earth_atmosphere.jpg';
import earthMoonTexture from '@/assets/images/moonmap.jpg';
import earthMoonBump from '@/assets/images/moonbump.jpg';
import marsTexture from '@/assets/images/marsmap.jpg';
import marsBump from '@/assets/images/marsbump.jpg';
import jupiterTexture from '@/assets/images/jupiter.jpg';
import ioTexture from '@/assets/images/jupiterIo.jpg';
import europaTexture from '@/assets/images/jupiterEuropa.jpg';
import ganymedeTexture from '@/assets/images/jupiterGanymede.jpg';
import callistoTexture from '@/assets/images/jupiterCallisto.jpg';
import saturnTexture from '@/assets/images/saturnmap.jpg';
import satRingTexture from '@/assets/images/saturn_ring.png';
import uranusTexture from '@/assets/images/uranus.jpg';
import uraRingTexture from '@/assets/images/uranus_ring.png';
import neptuneTexture from '@/assets/images/neptune.jpg';
import plutoTexture from '@/assets/images/plutomap.jpg';

// Your Three.js scene setup code goes here...

// Make sure to wrap the Three.js setup in a useEffect hook to ensure it runs on the client side
import { useEffect } from 'react';

const SolarSystem = () => {
  useEffect(() => {
    // Your Three.js initialization and animation loop here
    const scene = new THREE.Scene();
    // Example setup, please customize as per your needs
    ...
    // Your additional code for loading models, setting up lights, etc.
...
let gui;
const settings = {
  sunIntensity: 1, // Define a default value for sun intensity
  accelerationOrbit: 0,
  acceleration: 0,
};


    // Initialize GUI after the component mounts
    const initializeGui = async () => {
      const dat = await DatGui; // Correctly await the dynamic import
      gui = new dat.GUI({ autoPlace: false }); // Use the dat import
